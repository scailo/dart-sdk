...
@$core.Deprecated('Use cOMPONENT_REF_FROMDescriptor instead')
const COMPONENT_REF_FROM$json = {
  '1': 'COMPONENT_REF_FROM',
  '2': [
    {'1': 'COMPONENT_REF_FROM_ANY_UNSPECIFIED', '2': 0},
    {'1': 'COMPONENT_REF_FROM_INITIAL_STOCK', '2': 1},
    {'1': 'COMPONENT_REF_FROM_GOODS_RECEIPT', '2': 2},
    {'1': 'COMPONENT_REF_FROM_INWARD_JOB_FREE_ISSUE_MATERIAL', '2': 3},
    {'1': 'COMPONENT_REF_FROM_OUTWARD_JOB_FREE_ISSUE_MATERIAL', '2': 4},
    {'1': 'COMPONENT_REF_FROM_PRODUCTION_PLAN', '2': 5},
  ],
};

/// Descriptor for `COMPONENT_REF_FROM`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List cOMPONENT_REF_FROMDescriptor = $convert.base64Decode(
    'ChJDT01QT05FTlRfUkVGX0ZST00SJgoiQ09NUE9ORU5UX1JFRl9GUk9NX0FOWV9VTlNQRUNJRk'
    'lFRBAAEiQKIENPTVBPTkVOVF9SRUZfRlJPTV9JTklUSUFMX1NUT0NLEAESJAogQ09NUE9ORU5U'
    'X1JFRl9GUk9NX0dPT0RTX1JFQ0VJUFQQAhI1CjFDT01QT05FTlRfUkVGX0ZST01fSU5XQVJEX0'
    'pPQl9GUkVFX0lTU1VFX01BVEVSSUFMEAMSNgoyQ09NUE9ORU5UX1JFRl9GUk9NX09VVFdBUkRf'
    'Sk9CX0ZSRUVfSVNTVUVfTUFURVJJQUwQBBImCiJDT01QT05FTlRfUkVGX0ZST01fUFJPRFVDVE'
    'lPTl9QTEFOEAU=');

@$core.Deprecated('Use componentsServiceCreateRequestDescriptor instead')
const ComponentsServiceCreateRequest$json = {
  '1': 'ComponentsServiceCreateRequest',
  '2': [
...
/// Descriptor for `ComponentsServiceCreateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServiceCreateRequestDescriptor = $convert.base64Decode(
    'Ch5Db21wb25lbnRzU2VydmljZUNyZWF0ZVJlcXVlc3QSHwoLZW50aXR5X3V1aWQYASABKAlSCm'
    ...
    '4yGi5TY2FpbG8uQ09NUE9ORU5UX1JFRl9GUk9NUgdyZWZGcm9tEh4KBnJlZl9pZBggIAEoBEIH'
...
@$core.Deprecated('Use componentsServiceUpdateRequestDescriptor instead')
const ComponentsServiceUpdateRequest$json = {
  '1': 'ComponentsServiceUpdateRequest',
  '2': [
...
/// Descriptor for `ComponentsServiceUpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServiceUpdateRequestDescriptor = $convert.base64Decode(
    'Ch5Db21wb25lbnRzU2VydmljZVVwZGF0ZVJlcXVlc3QSIQoMdXNlcl9jb21tZW50GAEgASgJUg'
...
@$core.Deprecated('Use componentsServiceSendToStoreRequestDescriptor instead')
const ComponentsServiceSendToStoreRequest$json = {
  '1': 'ComponentsServiceSendToStoreRequest',
  '2': [
    {'1': 'user_comment', '3': 1, '4': 1, '5': 9, '10': 'userComment'},
    {'1': 'id', '3': 2, '4': 1, '5': 4, '8': {}, '10': 'id'},
    {
...
/// Descriptor for `ComponentsServiceSendToStoreRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServiceSendToStoreRequestDescriptor = $convert.base64Decode(
    'CiNDb21wb25lbnRzU2VydmljZVNlbmRUb1N0b3JlUmVxdWVzdBIhCgx1c2VyX2NvbW1lbnQYAS'
...
final $typed_data.Uint8List componentDescriptor = $convert.base64Decode(
    'CglDb21wb25lbnQSHwoLZW50aXR5X3V1aWQYASABKAlSCmVudGl0eVV1aWQSNAoIbWV0YWRhdG'
    ...
    'KA4yGi5TY2FpbG8uQ09NUE9ORU5UX1JFRl9GUk9NUgdyZWZGcm9tEhUKBnJlZl9pZBggIAEoBF'
...
/// Descriptor for `ComponentsList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsListDescriptor = $convert.base64Decode(
    'Cg5Db21wb25lbnRzTGlzdBIlCgRsaXN0GAEgAygLMhEuU2NhaWxvLkNvbXBvbmVudFIEbGlzdA'
    '==');

@$core.Deprecated('Use componentsServicePaginationReqDescriptor instead')
const ComponentsServicePaginationReq$json = {
  '1': 'ComponentsServicePaginationReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `ComponentsServicePaginationReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServicePaginationReqDescriptor = $convert.base64Decode(
    'Ch5Db21wb25lbnRzU2VydmljZVBhZ2luYXRpb25SZXESMAoJaXNfYWN0aXZlGAEgASgOMhMuU2'
...
@$core.Deprecated('Use componentsServicePaginationResponseDescriptor instead')
const ComponentsServicePaginationResponse$json = {
  '1': 'ComponentsServicePaginationResponse',
  '2': [
...
/// Descriptor for `ComponentsServicePaginationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServicePaginationResponseDescriptor =
    $convert.base64Decode(
        'CiNDb21wb25lbnRzU2VydmljZVBhZ2luYXRpb25SZXNwb25zZRIUCgVjb3VudBgBIAEoBFIFY2'
        '91bnQSFgoGb2Zmc2V0GAIgASgEUgZvZmZzZXQSFAoFdG90YWwYAyABKARSBXRvdGFsEisKB3Bh'
        'eWxvYWQYBCADKAsyES5TY2FpbG8uQ29tcG9uZW50UgdwYXlsb2Fk');

@$core.Deprecated('Use componentsServiceFilterReqDescriptor instead')
const ComponentsServiceFilterReq$json = {
  '1': 'ComponentsServiceFilterReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `ComponentsServiceFilterReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServiceFilterReqDescriptor = $convert.base64Decode(
    'ChpDb21wb25lbnRzU2VydmljZUZpbHRlclJlcRIwCglpc19hY3RpdmUYASABKA4yEy5TY2FpbG'
    ...
    '5DT01QT05FTlRfUkVGX0ZST01SB3JlZkZyb20SFQoGcmVmX2lkGCAgASgEUgVyZWZJZBIbCglm'
...
@$core.Deprecated('Use componentsServiceCountReqDescriptor instead')
const ComponentsServiceCountReq$json = {
  '1': 'ComponentsServiceCountReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `ComponentsServiceCountReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServiceCountReqDescriptor = $convert.base64Decode(
    'ChlDb21wb25lbnRzU2VydmljZUNvdW50UmVxEjAKCWlzX2FjdGl2ZRgBIAEoDjITLlNjYWlsby'
    ...
    'gEUgtwYXJlbnRSZWZJZBI1CghyZWZfZnJvbRgfIAEoDjIaLlNjYWlsby5DT01QT05FTlRfUkVG'
...
/// Descriptor for `ComponentsServiceSearchAllReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List componentsServiceSearchAllReqDescriptor = $convert.base64Decode(
    'Ch1Db21wb25lbnRzU2VydmljZVNlYXJjaEFsbFJlcRIwCglpc19hY3RpdmUYASABKA4yEy5TY2'
    ...
    'JlZl9pZBgeIAEoBFILcGFyZW50UmVmSWQSNQoIcmVmX2Zyb20YHyABKA4yGi5TY2FpbG8uQ09N'
    'UE9ORU5UX1JFRl9GUk9NUgdyZWZGcm9tEhUKBnJlZl9pZBggIAEoBFIFcmVmSWQSGwoJZmFtaW'
