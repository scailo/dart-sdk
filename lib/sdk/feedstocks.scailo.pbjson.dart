...
@$core.Deprecated('Use fEEDSTOCK_REF_FROMDescriptor instead')
const FEEDSTOCK_REF_FROM$json = {
  '1': 'FEEDSTOCK_REF_FROM',
  '2': [
    {'1': 'FEEDSTOCK_REF_FROM_ANY_UNSPECIFIED', '2': 0},
    {'1': 'FEEDSTOCK_REF_FROM_INITIAL_STOCK', '2': 1},
    {'1': 'FEEDSTOCK_REF_FROM_GOODS_RECEIPT', '2': 2},
    {'1': 'FEEDSTOCK_REF_FROM_INWARD_JOB_FREE_ISSUE_MATERIAL', '2': 3},
  ],
};

/// Descriptor for `FEEDSTOCK_REF_FROM`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List fEEDSTOCK_REF_FROMDescriptor = $convert.base64Decode(
    'ChJGRUVEU1RPQ0tfUkVGX0ZST00SJgoiRkVFRFNUT0NLX1JFRl9GUk9NX0FOWV9VTlNQRUNJRk'
    'lFRBAAEiQKIEZFRURTVE9DS19SRUZfRlJPTV9JTklUSUFMX1NUT0NLEAESJAogRkVFRFNUT0NL'
    'X1JFRl9GUk9NX0dPT0RTX1JFQ0VJUFQQAhI1CjFGRUVEU1RPQ0tfUkVGX0ZST01fSU5XQVJEX0'
    'pPQl9GUkVFX0lTU1VFX01BVEVSSUFMEAM=');

@$core.Deprecated('Use feedstocksServiceCreateRequestDescriptor instead')
const FeedstocksServiceCreateRequest$json = {
  '1': 'FeedstocksServiceCreateRequest',
  '2': [
...
/// Descriptor for `FeedstocksServiceCreateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServiceCreateRequestDescriptor = $convert.base64Decode(
    'Ch5GZWVkc3RvY2tzU2VydmljZUNyZWF0ZVJlcXVlc3QSHwoLZW50aXR5X3V1aWQYASABKAlSCm'
    ...
    '4yGi5TY2FpbG8uRkVFRFNUT0NLX1JFRl9GUk9NUgdyZWZGcm9tEh4KBnJlZl9pZBggIAEoBEIH'
...
@$core.Deprecated('Use feedstocksServiceUpdateRequestDescriptor instead')
const FeedstocksServiceUpdateRequest$json = {
  '1': 'FeedstocksServiceUpdateRequest',
  '2': [
...
/// Descriptor for `FeedstocksServiceUpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServiceUpdateRequestDescriptor = $convert.base64Decode(
    'Ch5GZWVkc3RvY2tzU2VydmljZVVwZGF0ZVJlcXVlc3QSIQoMdXNlcl9jb21tZW50GAEgASgJUg'
...
@$core.Deprecated('Use feedstocksServiceSendToStoreRequestDescriptor instead')
const FeedstocksServiceSendToStoreRequest$json = {
  '1': 'FeedstocksServiceSendToStoreRequest',
  '2': [
    {'1': 'user_comment', '3': 1, '4': 1, '5': 9, '10': 'userComment'},
    {'1': 'id', '3': 2, '4': 1, '5': 4, '8': {}, '10': 'id'},
    {
...
/// Descriptor for `FeedstocksServiceSendToStoreRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServiceSendToStoreRequestDescriptor = $convert.base64Decode(
    'CiNGZWVkc3RvY2tzU2VydmljZVNlbmRUb1N0b3JlUmVxdWVzdBIhCgx1c2VyX2NvbW1lbnQYAS'
...
@$core.Deprecated('Use feedstockDescriptor instead')
const Feedstock$json = {
  '1': 'Feedstock',
  '2': [
    {'1': 'entity_uuid', '3': 1, '4': 1, '5': 9, '10': 'entityUuid'},
    {
...
/// Descriptor for `Feedstock`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstockDescriptor = $convert.base64Decode(
    'CglGZWVkc3RvY2sSHwoLZW50aXR5X3V1aWQYASABKAlSCmVudGl0eVV1aWQSNAoIbWV0YWRhdG'
    ...
    'KA4yGi5TY2FpbG8uRkVFRFNUT0NLX1JFRl9GUk9NUgdyZWZGcm9tEhUKBnJlZl9pZBggIAEoBF'
...
@$core.Deprecated('Use feedstocksListDescriptor instead')
const FeedstocksList$json = {
  '1': 'FeedstocksList',
  '2': [
    {
      '1': 'list',
...
/// Descriptor for `FeedstocksList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksListDescriptor = $convert.base64Decode(
    'Cg5GZWVkc3RvY2tzTGlzdBIlCgRsaXN0GAEgAygLMhEuU2NhaWxvLkZlZWRzdG9ja1IEbGlzdA'
    '==');

@$core.Deprecated('Use feedstocksServicePaginationReqDescriptor instead')
const FeedstocksServicePaginationReq$json = {
  '1': 'FeedstocksServicePaginationReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `FeedstocksServicePaginationReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServicePaginationReqDescriptor = $convert.base64Decode(
    'Ch5GZWVkc3RvY2tzU2VydmljZVBhZ2luYXRpb25SZXESMAoJaXNfYWN0aXZlGAEgASgOMhMuU2'
...
@$core.Deprecated('Use feedstocksServicePaginationResponseDescriptor instead')
const FeedstocksServicePaginationResponse$json = {
  '1': 'FeedstocksServicePaginationResponse',
  '2': [
...
/// Descriptor for `FeedstocksServicePaginationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServicePaginationResponseDescriptor =
    $convert.base64Decode(
        'CiNGZWVkc3RvY2tzU2VydmljZVBhZ2luYXRpb25SZXNwb25zZRIUCgVjb3VudBgBIAEoBFIFY2'
        '91bnQSFgoGb2Zmc2V0GAIgASgEUgZvZmZzZXQSFAoFdG90YWwYAyABKARSBXRvdGFsEisKB3Bh'
        'eWxvYWQYBCADKAsyES5TY2FpbG8uRmVlZHN0b2NrUgdwYXlsb2Fk');

@$core.Deprecated('Use feedstocksServiceFilterReqDescriptor instead')
const FeedstocksServiceFilterReq$json = {
  '1': 'FeedstocksServiceFilterReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `FeedstocksServiceFilterReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServiceFilterReqDescriptor = $convert.base64Decode(
    'ChpGZWVkc3RvY2tzU2VydmljZUZpbHRlclJlcRIwCglpc19hY3RpdmUYASABKA4yEy5TY2FpbG'
    ...
    '5GRUVEU1RPQ0tfUkVGX0ZST01SB3JlZkZyb20SFQoGcmVmX2lkGCAgASgEUgVyZWZJZBIbCglm'
...
@$core.Deprecated('Use feedstocksServiceCountReqDescriptor instead')
const FeedstocksServiceCountReq$json = {
  '1': 'FeedstocksServiceCountReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `FeedstocksServiceCountReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServiceCountReqDescriptor = $convert.base64Decode(
    'ChlGZWVkc3RvY2tzU2VydmljZUNvdW50UmVxEjAKCWlzX2FjdGl2ZRgBIAEoDjITLlNjYWlsby'
    ...
    'gEUgtwYXJlbnRSZWZJZBI1CghyZWZfZnJvbRgfIAEoDjIaLlNjYWlsby5GRUVEU1RPQ0tfUkVG'
...
@$core.Deprecated('Use feedstocksServiceSearchAllReqDescriptor instead')
const FeedstocksServiceSearchAllReq$json = {
  '1': 'FeedstocksServiceSearchAllReq',
  '2': [
    {
      '1': 'is_active',
      '3': 1,
...
/// Descriptor for `FeedstocksServiceSearchAllReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedstocksServiceSearchAllReqDescriptor = $convert.base64Decode(
    'Ch1GZWVkc3RvY2tzU2VydmljZVNlYXJjaEFsbFJlcRIwCglpc19hY3RpdmUYASABKA4yEy5TY2'
    ...
    'JlZl9pZBgeIAEoBFILcGFyZW50UmVmSWQSNQoIcmVmX2Zyb20YHyABKA4yGi5TY2FpbG8uRkVF'
    'RFNUT0NLX1JFRl9GUk9NUgdyZWZGcm9tEhUKBnJlZl9pZBggIAEoBFIFcmVmSWQSGwoJZmFtaW'
